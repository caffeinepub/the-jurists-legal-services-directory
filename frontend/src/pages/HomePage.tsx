...
import { Scale, Heart, Building2, Shield, Gavel, Home, ArrowRight, CheckCircle2, Clock, Zap } from 'lucide-react';
    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-primary py-10 md:py-12">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute -left-8 top-1/2 -translate-y-1/2 w-48 h-48 rounded-full border-4 border-secondary" />
          <div className="absolute -right-8 top-1/2 -translate-y-1/2 w-64 h-64 rounded-full border-4 border-secondary" />
        </div>
        ...
        <div className="container relative">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-5 text-center sm:text-left">
              <div className="flex-shrink-0 w-14 h-14 rounded-full bg-secondary/20 border-2 border-secondary/40 flex items-center justify-center">
                <Clock className="h-7 w-7 text-secondary" />
              </div>
              <div className="space-y-1">
                <div className="flex items-center justify-center sm:justify-start gap-2 mb-1">
                  <Zap className="h-4 w-4 text-secondary" />
                  <span className="text-secondary text-sm font-semibold uppercase tracking-widest">Fast Legal Action</span>
                </div>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
                  Send a Legal Notice&nbsp;/&nbsp;Reply to a Legal Notice
                </h2>
                <p className="text-primary-foreground/80 text-lg font-medium">
                  under <span className="text-secondary font-bold">24 hours</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex-shrink-0">
              <Button
                size="lg"
                className="bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold text-base px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-200 border-2 border-secondary/60"
                asChild
              >
                <Link to="/contact">
                  Connect Now
