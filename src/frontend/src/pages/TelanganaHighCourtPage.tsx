...
const highCourtMatters = [
  {
    ...
    desc: "Filing and arguing writ petitions under Articles 226 and 227 of the Constitution for enforcement of fundamental rights.",
  },
  {
    icon: Scale,
    title: "Civil Appeals",
    desc: "Representation in civil appeals challenging lower court decisions before the High Court bench.",
  },
  {
    icon: BookOpen,
    title: "Criminal Appeals",
    desc: "Handling criminal appeals, revisions, and bail applications before the High Court.",
  },
  {
    icon: Star,
    title: "Constitutional Matters",
    desc: "Challenging unconstitutional laws and government actions through constitutional litigation.",
  },
];
...
export default function TelanganaHighCourtPage() {
  return (
    <>
      <SEOHead
        title="Telangana High Court – The Jurists"
        description="Information about The Jurists' practice at the Telangana High Court, covering writ petitions, civil and criminal appeals, constitutional matters, and more."
          ...
          <div className="border-2 border-white p-8 lg:p-12 relative overflow-hidden">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
                The Jurists practises before the Hon'ble High Court of Telangana
                at Hyderabad. This page provides information about the High
                Court matters handled by our advocates, including constitutional
                matters, writs, appeals, and revisions.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm leading-relaxed">
              Our High Court practice spans all major areas of law. The
              following practice areas are handled before the Telangana High
              Court:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl font-bold text-black mb-6">
                High Court Practice at The Jurists
              </h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  The Telangana High Court is the apex court for the state,
                  exercising original, appellate, and supervisory jurisdiction.
                  Appearing before the High Court requires deep legal knowledge
                  and the ability to address complex points of law.
                </p>
                <p>
                  Our advocates have experience in High Court litigation, having
                  handled writ petitions, appeals, and constitutional matters.
                  We are familiar with the procedural requirements and standards
                  of the Hon'ble Court.
                </p>
                <p>
                  This page provides information about the types of High Court
                  matters handled by The Jurists, including challenges to
                  government orders, appeals from lower courts, and applications
                  for interim relief.
                </p>
              </div>
      ...
      <section className="bg-black text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-3xl font-bold mb-4">
            Information About High Court Matters
          </h2>
          <p className="text-gray-400 mb-8">
            For information about High Court matters or to submit an enquiry,
            please use the contact form. This website is for informational
