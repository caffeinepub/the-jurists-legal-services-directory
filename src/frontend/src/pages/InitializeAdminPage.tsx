...
import {
  ...
  useIsAdminActorFieldInitialized,
...
export default function InitializeAdminPage() {
  ...
  const { data: isInitialized, isLoading: checkingInit } =
    useIsAdminActorFieldInitialized();
      ...
      <div className="max-w-md w-full bg-white border border-border rounded-xl shadow-professional-lg p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground">
            Initialize the admin access control system for The Jurists
            dashboard.
          </p>
        </div>
        ...
        {checkingInit ? (
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
            ...
            <p className="text-xs text-green-600 mt-1">
              Redirecting to leads dashboard...
            </p>
          </div>
        ) : (
