...
import { type Variant, Variant__3 } from "../backend";
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center border border-black p-10">
          <h1 className="font-serif text-2xl font-bold text-black mb-3">
            Access Denied
          </h1>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-b border-black bg-black">
                  <TableHead className="text-white font-medium uppercase tracking-wide text-xs">
                    Name
                  </TableHead>
                  <TableHead className="text-white font-medium uppercase tracking-wide text-xs">
                    Email
                    ...
                    <TableCell>
                      <select
                        ...
                        onChange={(e) =>
                          updateStatus.mutate({
                            id: s.id,
                            status: e.target.value as Variant,
                          })
                        }
